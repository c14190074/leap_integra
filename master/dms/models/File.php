<?php
	class File extends SnlActiveRecord {
		public $file_id, $folder_id, $name, $nomer, $perihal, $unit_kerja, $keyword, $related_document, $description, $created_on, $created_by, $updated_on, $updated_by, $is_deleted;
