                    ...
                    <div class="card-body">
						...
						<form role="form text-left" id="app_form_upload" action="<?= Snl::app()->baseUrl() ?>admin/files/revisidocument" method="POST">
						    ...
						    <div class="form-group">
						        ...
						        <div class="col-md-12">
						            <?= Snl::chtml()->activeTextbox($model, 'perihal') ?>
						        </div>
						    </div>
                            ...
                            <div class="form-group">
						        <div class="col-md-12 text-center">
						            ...
						            <button type="button" class="btn bg-gradient-warning mt-4 mb-0" data-dismiss="modal-revisi-form" id="close-revisi-form">Cancel</button>
						        </div>
						    </div>
                        </form>
                    </div>
